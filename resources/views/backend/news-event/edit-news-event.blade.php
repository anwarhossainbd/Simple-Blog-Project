                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{route('news_events.update')}}" id="myForm" enctype="multipart/form-data">
                                    @csrf

                                    <div class="col-sm-6 offset-3">
                                        <label>Date</label>
                                        <input type="text" name="date"  id="datepicker" value="{{$editdata->date}}" readonly
                                               class="form-control">
                                        {{--
                                    ...
                                    <div class="col-sm-4 offset-4">
                                        <img id="showImage" src="{{(!empty($editdata->image)) ? url($editdata->image):url('public/upload/anwar.jpg') }}" height="100px" width="100px">
